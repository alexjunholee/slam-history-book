...
같은 시기 Albrecht Meydenbauer는 건축물 보존을 위한 **건축 사진측량(architectural photogrammetry)**을 체계화했다. 1858년 그는 교회 외벽을 측량하다 추락사고를 겪은 뒤, 사진으로 대신할 수 있다는 생각을 품었다.
...
1958년 보고서 "A Solution for the General Problem of Multiple Station Analytical Stereotriangulation"에서 Brown은 처음으로 **bundle adjustment**를 수치적으로 공식화했다.
